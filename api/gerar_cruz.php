...
try {
    // PADRONIZAÇÃO: tabela_encontros e codigo em minúsculo
    ...
    // Ajustado para colunas: ele, ela, cod_membros, cod_encontro
...
<head>
    ...
    <style>
        ...
        .pagina {
            ...
            padding: 5mm;
            gap: 2mm;
            page-break-after: always; /* Garante que cada grupo de 4 saia em uma folha nova */
        }
...
<?php 
// Divide os casais em grupos de 4 para gerar várias páginas
    ...
    <div class="card">
        ...
        <div class="conteudo">
            ...
            <div class="nome-paroquia">
                Paróquia de São Francisco de Assis - Patos/PB
            </div>
        </div>
    </div>
    <?php endforeach; ?>

    ...
    <main class="content">
        <div class="form-card full-width">
            <header class="form-header header-flex">
                ...
                <div class="actions">
                    <a href="vincular_vivenciando.php" class="btn btn-secondary" style="text-decoration: none;">
                        + Novo Encontrista
                    </a>
                </div>
            </header>
...
>>>>>>> 83776864ccebc41a8f0430e1d4a061408e652141:vivenciando.html
</html>
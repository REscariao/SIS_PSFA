...
--
-- Host: localhost
-- Tempo de geração: 23/02/2026 às 04:29
...
INSERT INTO `tabela_ciclos` (`cod_encontro`, `cod_circulo`, `cod_membro`, `coordenador`) VALUES
(1, 1, 41, 'Não'),
(1, 2, 42, 'Não'),
(1, 3, 43, 'Não'),
(1, 4, 44, 'Não'),
...
--
-- Despejando dados para a tabela `tabela_encontristas`
--

INSERT INTO `tabela_encontristas` (`Codigo`, `Etapa`, `Cod_Membros`, `Cod_Encontro`, `Cod_Circulo`, `Imprimir`) VALUES
(1, 1, 41, 1, 1, 1),
(2, 1, 42, 1, 2, 1),
(3, 1, 43, 1, 3, 1),
(4, 1, 44, 1, 4, 1),
...
(1, 1, 'XXIV ECC São Francisco de Assis', 'Maio/2026', 'Família, Dom de Deus', NULL, 2026);
...
(1, 1, 'Coordenador Geral', 'Equipe', 1),
(1, 2, 'Sala', 'Equipe', 1),
(1, 3, 'Compras', 'Equipe', 1),
(1, 4, 'Cafezinho e Minimercado', 'Equipe', 1),
(1, 5, 'Ordem e Limpeza', 'Equipe', 1),
(1, 6, 'Secretaria', 'Equipe', 1),
(1, 7, 'Cozinha', 'Equipe', 1),
(1, 8, 'Acolhida', 'Equipe', 1),
(1, 9, 'Liturgia e Vigília', 'Equipe', 1),
(1, 10, 'Visitação', 'Equipe', 1),
(1, 11, 'Círculos', 'Equipe', 1),
(1, 12, 'Coordenador Geral', 'Equipe', 1),
(1, 13, 'Sala', 'Equipe', 1),
(1, 14, 'Compras', 'Equipe', 1),
(1, 15, 'Cafezinho e Minimercado', 'Equipe', 1),
(1, 16, 'Ordem e Limpeza', 'Equipe', 1),
(1, 17, 'Secretaria', 'Equipe', 1),
(1, 18, 'Cozinha', 'Equipe', 1),
(1, 19, 'Acolhida', 'Equipe', 1),
(1, 20, 'Liturgia e Vigília', 'Equipe', 1),
(1, 21, 'Visitação', 'Equipe', 1),
(1, 22, 'Círculos', 'Equipe', 1),
(1, 23, 'Coordenador Geral', 'Equipe', 1),
(1, 24, 'Sala', 'Equipe', 1),
(1, 25, 'Compras', 'Equipe', 1),
(1, 26, 'Cafezinho e Minimercado', 'Equipe', 1),
(1, 27, 'Ordem e Limpeza', 'Equipe', 1),
(1, 28, 'Secretaria', 'Equipe', 1),
(1, 29, 'Cozinha', 'Equipe', 1),
(1, 30, 'Acolhida', 'Equipe', 1),
(1, 31, 'Liturgia e Vigília', 'Equipe', 1),
(1, 32, 'Visitação', 'Equipe', 1),
(1, 33, 'Círculos', 'Equipe', 1),
(1, 34, 'Coordenador Geral', 'Equipe', 1),
(1, 35, 'Sala', 'Equipe', 1),
(1, 36, 'Compras', 'Equipe', 1),
(1, 37, 'Cafezinho e Minimercado', 'Equipe', 1),
(1, 38, 'Ordem e Limpeza', 'Equipe', 1),
(1, 39, 'Secretaria', 'Equipe', 1),
(1, 40, 'Cozinha', 'Equipe', 1);
...
(4, 'Amarildo Cabral Leite', 'Lobão', NULL, NULL, 'Arisangela Araújo Nóbrega Leite', 'Arisangela', NULL, NULL, NULL, 'XXIV 2015 Azul', NULL, NULL, 'Desmembramento', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
...
(10, 'Emerson Leandro Rodrigues', 'Mecinho', NULL, NULL, 'Erta Soraya Ribeiro César Rodrigues', 'Erta', NULL, NULL, NULL, '25-2017', 'Pastoral Familiar e Liturgia', NULL, 'Desmembramento', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
...
(19, 'Henrique José de Carvalho Gomes', NULL, NULL, NULL, 'Fabiana Martins Laurindo', 'Fabiana', NULL, NULL, NULL, 'Número 31 Ano 2024', 'Apostolado da Oração', NULL, 'Desmembramento', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
...
(46, 'André Lopes Lima', 'André', NULL, NULL, 'Maria Rosalva Furtado Neto', 'Maria', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(47, 'Marcos Antonio Estrela', 'Marcos', NULL, NULL, 'Mislainy de Caldas Batista', 'Mislainy', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(48, 'Fabiano de Caldas Batista', 'Fabiano', NULL, NULL, 'Mona Lisa Lopes Santos Caldas', 'Mona Lisa', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
...
(50, 'Adigley Janio Mendes', NULL, NULL, NULL, 'Ryanne Diniz Mamede', 'Ryanne', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(51, 'Julio Cesar Fernandes de Freitas', 'Julio', NULL, NULL, 'Iohannah Almeida de Freitas', 'Iohannah ', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(52, 'Pedro Roberto de Matos Pereira', 'Pedro', NULL, NULL, 'Milene Sarmento M de Matos', 'Milene', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(53, 'Helleno de Sousa Ó Netto', NULL, NULL, NULL, 'Jaqueline Oliveira do Ó', 'Jaqueline', NULL, NULL, NULL, '2015', NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(54, 'Jair Junior', NULL, NULL, NULL, 'Julia', 'Julia', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, 'Mosoro', 'PB', NULL, 1, NULL, NULL, NULL),
(55, 'Emerson Medeiros Menesses', 'Merson', NULL, '1984-02-14', 'Monica Cosme Ribeiro Souza', 'Monica', NULL, NULL, NULL, '2022', NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(56, 'Ariosvaldo Lucena de Sousa Junior', 'BH', NULL, NULL, 'Izabelle Cristinne F de O Doia', 'Izabelle', NULL, NULL, NULL, '2008', NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(57, 'Roberto Nicacio Leite Segundo', 'Segundo', NULL, NULL, 'Amanda Leite Felix', 'Amanda', NULL, NULL, NULL, '2017', NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(58, 'Dário Leitão Nunes', 'Dário', NULL, NULL, 'Maria do Socorro Sousa dos S. L. Nunes', 'Maria do Socorro', NULL, NULL, NULL, '1998', NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(59, 'Francisco de Assis Martins de Barros', 'Chico', NULL, NULL, 'Celiete Dantas Batista', 'Celiete', NULL, NULL, NULL, '2008', NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(60, 'José Adriano da Silva Tenorio', 'Adriano', NULL, NULL, 'Andreza da Gama Silva Tenorio', 'Andreza', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, 'Matureia', 'PB', '83981863127', 1, NULL, NULL, NULL),
(61, 'Pedro Cordeiro de Lira Neto', 'Pedro', NULL, NULL, 'Vitória Maria Vieira Rocha', 'Vitória', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(62, 'Wendell Marinho Henrique', 'Pequeno', NULL, NULL, 'Dannuza Lucena Viana', 'Dannuza ', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(63, 'João Lopes de Sousa Neto', 'João', NULL, NULL, 'Fabiana Casusa de Oliveira', 'Fabiana ', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(64, 'Semião Oliveira de Medeiros', NULL, NULL, NULL, 'Maria de Fátima Porfírio de Medeiros', 'Maria de Fátima ', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(65, 'José de Assis Mendes Meira Junior', 'José', NULL, NULL, 'Maria do Socorro da Costa Meira', 'Maria', NULL, NULL, NULL, NULL, NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(66, 'Rogério Lacerda Estrela Alves', 'Rogério ', NULL, NULL, 'Glaúcia Maria D. da Silva Estrela', 'Glaúcia ', NULL, NULL, NULL, '2011', NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),
(67, 'Walber barreto martins da Nóbrega', 'Walber', NULL, NULL, 'Layse Júlia Abílio Diniz Melquiades de Medeiros Martins', 'Layse', NULL, NULL, NULL, '2016', NULL, NULL, 'Tranferencia', NULL, NULL, NULL, NULL, NULL, 'PB', NULL, 1, NULL, NULL, NULL),

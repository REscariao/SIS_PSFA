...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // --- UNICA ALTERAÇÃO: GARANTIR QUE A PASTA EXISTE ---
        if (!is_dir("uploads")) {
...
<header class="navbar">
    <div class="nav-container">
        <a href="dashboard.html" class="logo"><img src="img/logoParoquia.png" width="270" alt="Logo"></a>
        <nav>
            <ul class="nav-links">
                <li><a href="membros.php">Voltar</a></li>
                <li><a href="logout.php" class="btn-logout"><i class="fa-solid fa-power-off"></i></a></li>
            </ul>
        </nav>
    </div>
</header>
...
<main class="content">
    <div class="form-card full-width">
        <header class="form-header">
            ...
            <p>Os arquivos serão salvos na pasta exclusiva da sua paróquia.</p>
        </header>
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label>Data Nascimento (Ele)</label>
                    <input type="date" name="nasc_ele" class="form-control">
                </div>
                ...
                <div class="form-group">
                    <label>Data Nascimento (Ela)</label>
                    <input type="date" name="nasc_ela" class="form-control">
                </div>

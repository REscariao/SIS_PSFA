...
<head>
    <meta charset="UTF-8">
    <title>Gestão de Convites - Sistema Paroquial</title>
        ...
        <div class="form-card full-width">
             <header class="form-header header-flex" style="display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 20px;">
                <div style="display: flex; align-items: flex-end; gap: 15px; flex-wrap: wrap;">
                    <div>
                        <h2>Gestão de Convites & Escalas</h2>
                        <p>Filtre por encontro para gerenciar os casais e imprimir as convocações.</p>
                        <div style="display: flex; align-items: center; gap: 15px; margin-top: 15px;">
                            ...
                            <a href="montar_equipe.php" class="btn btn-primary" style="min-width: 200px;">
            ...
            <div id="lista-equipes-convites">
                <div style="text-align:center; padding: 80px 20px;">
                    ...
                    <h3 style="color: #666;">Aguardando Seleção</h3>
    ...
    <script>
        ...
        async function carregarConvites(idEncontro) {
            ...
            try {
                    ...
                    <div class="equipe-card">
                        <div class="equipe-header">
                            ...
                            <a href="api/gerar_convite_oficial.php?encontro=${idEncontro}&equipe=${encodeURIComponent(nomeEquipe)}" 
                               target="_blank" class="btn-print-sm">🖨️ Imprimir Convites da Equipe</a>
                        </div>
                ...
                container.innerHTML = '<p style="text-align:center; color:red; padding:40px;">Erro de conexão com a API.</p>';
            }
        }
...
>>>>>>> 83776864ccebc41a8f0430e1d4a061408e652141:convites.html
</html>